...
export class IdentityQuantumState {
  ...
  toFragment(): ResonantFragment {
    ...
    if (this.primeResonance) {
      coeffs.set(this.primeResonance.gaussianPrime, this.coherence);
      coeffs.set(this.primeResonance.eisensteinPrime, this.coherence * 0.9);
      coeffs.set(this.primeResonance.quaternionicPrime, this.coherence * 0.8);
    } else {
